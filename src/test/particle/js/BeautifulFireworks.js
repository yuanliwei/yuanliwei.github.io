var BeautifulFireworks = (function () {
  ...
  function BeautifulFireworks(canvasId, fireAudio, bombAudio) {
    ...
    function Particle( x, y ) {
      ...
      this.decay = random( 0.0025, 0.013 );
    }
    ...
    function loop() {
      ...
      while (stars--) {
        ctx.beginPath();
        ctx.fillRect(cw * Math.random(),ch * Math.random() ,2 * window.devicePixelRatio ,2 * window.devicePixelRatio);
